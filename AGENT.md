...
|---|---|---|---|---|
| `wechat-on-cloud/` | 云微(飞牛云微信) | 1.4.9-3 | Gloridust/WechatOnCloud | [AGENT.md](./wechat-on-cloud/AGENT.md) |
| `hyatlas/` | HyAtlas(混元记忆) | 4.1.1-6 | tuancookiez-hub/HyAtlas-Memory | [AGENT.md](./hyatlas/AGENT.md) |
| `octopus/` | Octopus(LLM 网关) | 0.13.5-1 | bestruirui/octopus | [AGENT.md](./octopus/AGENT.md) |
